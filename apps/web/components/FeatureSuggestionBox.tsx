...
export default function FeatureSuggestionBox({
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 border-2 border-purple-300 dark:border-purple-700 rounded-lg p-4 mb-4 shadow-md animate-in slide-in-from-top duration-300">
      <div className="flex items-start gap-3">
        {/* Icon */}
        <div className="flex-shrink-0 mt-1">
          <div className="bg-purple-100 dark:bg-purple-800 rounded-full p-2">
            <LightBulbIcon className="h-5 w-5 text-purple-600 dark:text-purple-200" />
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-2">
            <h4 className="text-base font-semibold text-gray-900 dark:text-white">{suggestion.title}</h4>
            <span className="text-xs text-purple-600 dark:text-purple-300 bg-purple-100 dark:bg-purple-900/50 px-2 py-1 rounded-full whitespace-nowrap">
              AI Suggestion
            </span>
          </div>

          <p className="text-sm text-gray-700 dark:text-gray-200 mb-2">{suggestion.description}</p>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg text-sm font-medium transition-colors"
            >
